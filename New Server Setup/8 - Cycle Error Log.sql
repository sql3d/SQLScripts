/*
Creates nightly job that we cycle the SQL Server error log
Also, updates the registry to allow 30 SQL Server error logs
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Daily - Midnight', 
		...
		@active_start_date=20110901, 
		@active_end_date=99991231, 
		@active_start_time=0, 
		@active_end_time=235959, 
		@schedule_uid=N'1373351e-0b3a-437d-b01d-f890552f0465'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
