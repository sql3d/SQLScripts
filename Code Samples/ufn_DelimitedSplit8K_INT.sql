...
/****** Object:  UserDefinedFunction [dbo].[ufn_DelimitedSplit8K_INT]    Script Date: 3/27/2013 1:32:15 PM ******/
SET ANSI_NULLS ON
GO
...
GO
 ...
 CREATE FUNCTION [dbo].[ufn_DelimitedSplit8K_INT]
/**********************************************************************************************************************
 Purpose:
...
-----------------------------------------------------------------------------------------------------------------------
 ...
 Rev 08 - 08 Nov 2011 - Dan Denney, added conversion to INT for output table
**********************************************************************************************************************/
...
--===== "Inline" CTE Driven "Tally Table" produces values from 0 up to 10,000...
  ...
  WITH	E1(N) AS (
		...
		E2(N) AS (SELECT 1 
					FROM E1 a, E1 b), --10E+2 or 100 rows
		E4(N) AS (SELECT 1 
